    ...
    <main className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-r from-slate-900 to-slate-800 text-white">
        <div className="container mx-auto px-4 py-20 flex flex-col items-center text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Exquisite Jewelry Collection</h1>
          <p className="text-lg md:text-xl max-w-2xl mb-8 text-gray-200">
            Discover timeless elegance with our handcrafted jewelry pieces, designed to complement your unique style.
          </p>
          <a href="/products" className="px-6 py-3 bg-primary text-primary-foreground hover:bg-primary/90 rounded-md transition-colors">
            Shop Now
          </a>
        </div>
      </section>
